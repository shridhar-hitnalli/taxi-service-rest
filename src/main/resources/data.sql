...
VALUES(1, true, now(),  'ELECTRIC', 'MH12EU2422', 3.1, 4, 'volvo', false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED)
VALUES(2, true, now(),  'DIESEL', 'KA51ES1232', 4.2, 4, 'bmw', false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED)
VALUES(3, false, now(),  'HYBRID', 'MH02AS3532', 4.8, 6, 'tesla' ,false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED)
VALUES(4, false, now(),  'GAS', 'MH15AS0782', 4.1, 4, 'mercedes' ,false);

INSERT INTO car(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED)
VALUES(5, false, now(),  'HYBRID', 'MH01EE3413', 4.2, 4, 'volvo' ,false);